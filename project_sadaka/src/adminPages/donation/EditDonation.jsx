...
const EditDonation = () => {
    ...
    useEffect(() => {
        axios
            .get(
                `http://localhost/react_php_donation_management/php/donnetions/edit_donnetion.php?id=${id}`
            )
            .then((res) => {
    ...
    const save = () => {
        ...
        axios
            .post(
                "http://localhost/react_php_donation_management/php/donnetions/update_donations.php",
                formdata,
                {
                    headers: {
